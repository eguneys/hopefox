...
// @ts-ignore
import './fourth.gof?raw'
import { Visual_CompositeNestedGraphNode, Visual_CompositeNestedGraphRoot } from '../src/gof4/types'

let m = await PositionManager.make()
let log_puzzles = a_hundred

let data = fs.readFileSync('test/fourth.gof').toString()
